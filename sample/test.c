...
int main() {
	...
	//if(WiseAgent_OpenBySSL(SERVER_URL, 1883, "admin", "05155853", "", "", "", "") == 0) {
    	...
    	WiseSnail_RegisterSensor("000E4C000010", "OnBoard", infospec1, sizeof(infospec1)/sizeof(WiseSnail_InfoSpec));
        sleep(1);
        WiseSnail_RegisterSensor("000E4C000011", "OnBoard2", infospec2, sizeof(infospec2)/sizeof(WiseSnail_InfoSpec));
