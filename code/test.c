...
#define SERVER_URL            "advigw-mqtt-bus"
/*Info/reset
Action/AutoReport*/
...
int main() {
	...
	WiseSnail_Init("IotGW","", NULL, NULL, 0);
	WiseSnail_RegisterInterface("000E4CAB12BB", "Bluetooth", -1, interface1, 1);
...
retry:
	...
	goto retry;
    	...
    	WiseSnail_RegisterSensor("000E4C00BB10", "OnBoard", infospec1, sizeof(infospec1)/sizeof(WiseSnail_InfoSpec));
        sleep(1);
        WiseSnail_RegisterSensor("000E4C00BB11", "OnBoard2", infospec2, sizeof(infospec2)/sizeof(WiseSnail_InfoSpec));
    ...
    for(;;) {
        ...
        if(second == 0) {
            ...
            WiseSnail_Write("000E4C00BB10", data, 4);
			WiseSnail_Write("000E4C00BB11", data, 4);
