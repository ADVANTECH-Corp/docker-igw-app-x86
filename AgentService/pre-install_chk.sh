...
sqlite3 xterm ethtool lua5.1"

# ${DEVLE_PKG_NEED} is specify the depend packages to develop RMM cagent.
DEVLE_PKG_NEED="gcc g++ make \
libxml2-dev libcurl4-openssl-dev libx11-dev libxtst-dev libxext-dev libssl-dev \
libmosquitto-dev autoconf autotools-dev build-essential libtool lua5.1"
